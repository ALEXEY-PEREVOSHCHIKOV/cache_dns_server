...
from src.task2.dns_packets.config_dns import DNSConfig
from src.task2.dns_packets.dns_packet_creator import DNSCreator
...
class TestQuery(unittest.TestCase):
    ...
    def test_create_query(self):
        ...
        self.assertEqual('0' + bin(int(bytes_stream, 16))[2:], encoded_stream)
